    ...
    return (
        <div className={`min-h-screen max-w-7xl mx-auto ${inter.className}`}>
            <div className="p-8">
                ...
                <div className="bg-white rounded-b-lg px-8 py-8 space-y-6">
                    {/* Core Skills */}
                    <MultiSelectDropdown
                        label="Core Skills"
                        field="coreSkills"
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                        ...
                        <button className="bg-green-800 text-white px-8 py-3 rounded-md font-medium hover:bg-green-900 transition-colors">
                            Continue
                        </button>
                    </div>
                </div>
